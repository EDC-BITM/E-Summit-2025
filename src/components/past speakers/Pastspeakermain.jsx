...
function PastSpeakersmain() {
  ...
  return (
    <>
    <div className="w-full md:p-0 p-4 md:pt-12 overflow-x-hidden overflow-hidden relative my-28">
    <div className="absolute top-28 right-0 w-[400px] h-[300px] md:w-[500px] md:h-[400px] bg-green-500/30 rounded-full blur-3xl -z-10 md:-z-0" />
