      ...
      day1: [
        {
          ...
          title:
            "Opening Ceremony and Panel Discussion with Nidhi Banthia & Upasana Makati",
          location: "CAT Hall",
          link: "",
        },
      ],
    ...
    <section className="events pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          >
            {["day1", "day2", "day3"].map((day) => (
              <button
                ...
                className={`px-6 py-2 rounded-lg backdrop-blur-lg border border-[#616161] transition-all duration-300 ${
                  activeDay === day
          ...
          <div
            className={`grid ${
              scheduleData[activeDay].length === 1
                ? "grid-cols-1 place-items-center"
                : "md:grid-cols-2"
            } gap-6 transition-opacity duration-300 ${
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  <div>
                    ...
                    <h3 className="text-primaryText text-xl font-semibold mt-2">
                      {event.title}
                    </h3>
