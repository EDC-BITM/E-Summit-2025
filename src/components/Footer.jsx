      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start space-y-6 lg:space-y-0">
        ...
        <div className="flex-1">
          ...
          <p className="text-secondaryText px-4">
            Scale Your Story - Where ambitions rise, ideas thrive, and your
        ...
        <div className="flex-1 lg:pl-40">
          <div className="grid grid-cols-2 gap-4 text-primaryText">
            <h2 className="text-xl font-semibold mb-2 col-span-2 text-center lg:ml-[-11rem]">
              Contacts
            </h2>
            <div>
              ...
              <ul>
                <li className="text-secondaryText hover:text-primaryGreen">
                  <a
                    href="mailto:drie@bitmesra.ac.in"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Dean of RIE
                ...
                <li className="text-secondaryText hover:text-primaryGreen">
                  <a
                    href="mailto:vishalhshah@bitmesra.ac.in"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Faculty Advisor
              ...
              <ul>
                <li className="text-secondaryText hover:text-primaryGreen">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    Pranav Raj Srivastav
                  </a>
                </li>
                <li className="text-secondaryText hover:text-primaryGreen">
                  <a
                    href="mailto:btech10259.22@bitmesra.ac.in"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Yogesh Kumar
